...
class CheckoutDestinationTest extends TestCase
{
    /**
    ...
    {
        $this->login();
        $response = $this->post('/api/checkout/insert-checkout-destination',[
                'user_id' => 1,
                'palace_id' => 2,
                'total_price' => 30000,
                'firstname' => 'tama',
    ...
    {
        $this->login();
        $response = $this->get('/api/checkout/checkout-destination');
